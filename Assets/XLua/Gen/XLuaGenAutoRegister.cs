...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(LuaBehaviour.LuaBehaviour), LuaBehaviourLuaBehaviourWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XLuaFramework.Extension.UnityEx), XLuaFrameworkExtensionUnityExWrap.__Register);
            ...
            out TryArraySet genTryArraySetPtr)
		{
		    ...
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.UI.Button), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE0(XLuaFramework.Extension.UnityEx.OnClickSet)
				...
				{typeof(UnityEngine.UI.Slider), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE1(XLuaFramework.Extension.UnityEx.OnValueChangedSet)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
